  ...
  <body>
   ...
   <div class = "panel-heading">
    ...
    <div class="table-responsive">
		...
		//$table = teammember;
	    $sql = "SELECT M_id, firstName, lastName, email FROM teammember ORDER BY firstName";
	...
	while($row = $result->fetch_assoc()){
			...
			echo  "<td>"."<a href='updateusers.php?M_id=". $row['M_id']."'>"."<img src='img/edittask1.png'>". "</a>" . "</td>" ;
	 
			echo  "<td>"."<a href='commitdeleteuser.php?M_id=". $row['M_id']. "'>"."<img src='img/deleteuser.png'>". "</a>"."</td>" ;
