...
?>
  ...
  <div class="form-group">
	   <label class="control-label col-sm-3" for="email"></label>
      <div class="col-sm-5">
        <input type="date" class="form-control" id="title" name="sDate" value="<?php echo "$sDate"; ?>" required>
      </div>
    </div>      
...
<div class="form-group">
	   <label class="control-label col-sm-3" for="email"></label>
      <div class="col-sm-5">
        <input type="date" class="form-control" id="title" name="eDate" value="<?php echo "$eDate"; ?>" required>
      </div>
    </div>
